...
Copia paralela de src/web (ver src/main_v2.py) para probar cambios
estructurales de interfaz sin tocar la version en produccion. Comparte
config, consolidador y snapshot.json con la version original -- ningun
calculo se duplica ni se reimplementa aca."""
